...
exact-shape external f32 `POINTWISE` node 的 runtime override，并支持静态 f32
SDPA forward 的独立 ragged Q/K/V/O 和 paged K/V storage。更广泛 dynamic 行为、
backward/packed ragged/paged metadata、其他 physical reorder metadata、threading
和广泛 fusion 仍待实现。

...
[[nodiscard]] bool is_normalization_operation(
    import::OperationTag tag) noexcept;

[[nodiscard]] import::Status validate_normalization_operation(
    import::OperationTag tag,
    import::GenericOperationDesc const& operation,
    import::SerializedGraph const& graph,
    std::size_t node_index);

[[nodiscard]] import::Status emit_normalization_operation(
    import::OperationTag tag,

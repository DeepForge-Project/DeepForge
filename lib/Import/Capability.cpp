...
constexpr std::array<OperationCapability, 39> kCapabilities{{
    ...
    {OperationTag::kConcatenate, "CONCATENATE", CapabilityLevel::kParsed},
    ...
    {OperationTag::kMatmul, "MATMUL", CapabilityLevel::kParsed},
    ...
    {OperationTag::kPointwise, "POINTWISE", CapabilityLevel::kParsed},
    {OperationTag::kReduction, "REDUCTION", CapabilityLevel::kParsed},
    {OperationTag::kResample, "RESAMPLE", CapabilityLevel::kParsed},
    {OperationTag::kReshape, "RESHAPE", CapabilityLevel::kParsed},
    ...
    {OperationTag::kSlice, "SLICE", CapabilityLevel::kParsed},
    {OperationTag::kTranspose, "TRANSPOSE", CapabilityLevel::kParsed},
}};
